                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="<?php echo site_url('user/doaddkegiatan'); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="lokasi" required placeholder="Jalan Cendrawasih No 88, Yogyakarta">
                                    </div>
                                    <div class="help-info">Alamat Lokasi Kegiatan</div>
                                </div>
                                <div class="">
                                    <div class="form-line">      
                                        <div class="row clearfix">
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="latitude" required placeholder="Latitude Ex: -6.175392">
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" name="longitude" required placeholder="longitude Ex: 106.827156">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="datetime-local" class="form-control" name="tanggal" required placeholder="tanggal kegiatan">
                                    </div>
                                    <div class="help-info">Tanggal Kegiatan</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">      
                                        <textarea id="ckeditor" name="deskripsi" type="text" required="" class="form-control" placeholder="deskripsi kegiatan"></textarea>
                                    </div>
