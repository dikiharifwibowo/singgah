...
<head>
    ...
    <title>Register || Rumah Singgah </title>
    <!-- Favicon-->
...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Rumah <b>SINGGAH</b></a>
            <small>AMICTA 2017 - Dikih Arif || Elsa Diah</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_up" method="POST" action="<?php echo site_url('auth/create_user') ?>">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="company" placeholder="company atau nama rumah singgah" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
    ...
    <script src="<?php echo site_url('assets/admin/js/examples/sign-in.js'); ?>"></script>
</body>
